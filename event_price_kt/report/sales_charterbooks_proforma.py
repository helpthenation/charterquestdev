...
# import re
#
# class sales_charterbooks_kt(report_sxw.rml_parse):
#     def __init__(self, cr, uid, name, context):
#         super(sales_charterbooks_kt, self).__init__(cr, uid, name, context=context)
...
#     'report.sales_proforma_charterbooks',
#     'sale.order',
#     'addons/event_price_kt/report/sales_charterbooks_proforma.rml',
#     parser=sales_charterbooks_kt, header=False
# )
