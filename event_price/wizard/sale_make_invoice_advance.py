...
class sale_advance_payment_inv(models.TransientModel):
    ...
    advance_payment_method = fields.Selection(
            [('all', 'xxxInvoice the whole sales order'), ('percentage','Percentage'), ('fixed','Fixed price (deposit)'),
    ...
    qtty = fields.Float(string='Quantity', required=True, default=1.0)
    ...
    def _prepare_advance_invoice_vals(self, cr, uid, ids, context=None):
        ...
        for sale in sale_obj.browse(cr, uid, sale_ids, context=context):
            ...
            if not wizard.product_id.id :
                ...
                if not account_id:
                    raise exceptions.except_osv(_('Configuration Error!'),
            ...
            if wizard.amount <= 0.00:
                raise exceptions.except_osv(_('Incorrect Data'),
    ...
    def create_invoices(self, cr, uid, ids, context=None):
        ...
        if wizard.advance_payment_method == 'all':
            ...
            res = sale_obj.manual_invoice(cr, uid, ids, sale_ids, context)
